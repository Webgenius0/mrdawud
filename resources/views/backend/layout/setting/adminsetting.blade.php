                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Admin Panel Setting</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" class="form-control" value="{{ $setting->admin_title ?? '' }}" placeholder="System title" name="title"/>
                                            @error('title')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="system_short_name" class="form-control" value="{{ $setting->system_short_name ?? '' }}" placeholder="System short Name" name="system_short_name" />
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="copyright" id="copyright" value="{{ $setting->copyright_text ?? '' }}" placeholder="Copyright Text">
                                            @error('copyright')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary mr-1">Submit Update</button>
