...
@section('content')
    <main class="app-content content">
        <h2 class="section-title">Locations Page</h2>
            ...
            <div class="card-body">
                <div class="table-responsive p-4">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.location.create') }}" class="btn btn-primary" type="button">
...
@push('script')
    <script>
        ...
        function changeStatus(id) {
            ...
            let statusUrl = '{{ route('admin.location.status', ':id') }}'.replace(':id', id);
